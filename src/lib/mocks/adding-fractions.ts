 ...
 */
import { AFFECTIVE_STATES, BREAK_TYPES, MODALITY, DENSITY, CALC_MODALITY, SCAFFOLD_LEVELS } from "@/lib/constants";
...
export const ADDING_FRACTIONS_PLAN: AdaptationPlan = {
  ...
  segments: [
    ...
    { segmentId: "intro", startModality: MODALITY.TEXT, density: null, suggestModality: null, breakAfter: BREAK_TYPES.MICRO, scaffold: SCAFFOLD_LEVELS.MINIMAL, affect: AFFECTIVE_STATES.BOREDOM },
